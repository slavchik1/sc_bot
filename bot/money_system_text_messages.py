...
def money_register(platform_type, id):
    return f"Вибачте, але поку у боті нема автоматичної реестрації. Тому для реєстрації будь ласка напишіть головному адніму для ручної реестрації. Для реєстрації потрібно указати ваш рід(чоловічий, жіночий або середній) та ваш телеграм та/або діскорд id. Ваш {platform_type} id: {id}. Щоб отримати id на іншій платформі напишіть /register на іншій платформі."
