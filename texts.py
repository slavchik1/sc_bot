...
start__ = ("Slavcraft бот ввімкнений. Для допомоги у боті напишіть /help_.")
...
help__ = ("""/start – уввімкнути бота.
/help_ – допомога у боті.
/about – інформація про бота.
/credits – творці бота.
/rules – правила Славкрафту.
/ip – ip Славкрафту.
...
version_ = ("Версія цього бота: розробка 0.1")
